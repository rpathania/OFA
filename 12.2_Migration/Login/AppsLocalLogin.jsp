...
RCS_ID $Header: AppsLocalLogin.jsp 120.12.12020000.18 2018/04/25 14:43:59 ctilley ship $


Lightweight Login:
    No HTTPSession is created 
    No ICX session is created unless necesary
    
    
    The JSP is almot pure HTML.
    The Java code recides on oracle.apps.fnd.login.LoginHelper.
    The Java code supplies CSS and supporting JavaScript.
    
--%>

<%@ page contentType="text/html;charset=UTF-8"%>
<%@ page session="false" %>
<%@ page language="java" extends="oracle.apps.fnd.login.LoginHelper"%>
<% if (service( getServletConfig(),request,response,out) ) return;%>
